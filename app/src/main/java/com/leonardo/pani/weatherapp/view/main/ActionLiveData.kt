...
//This class is essential to call the livedata only when its value changes so that whenever the fragment is created, the Livedata is not called again with the same value
