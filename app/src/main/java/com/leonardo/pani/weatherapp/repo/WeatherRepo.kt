...
class WeatherRepo @Inject constructor(private val api:SearchPlaceApi, private val api2: WeatherForecastApi, private val api3: DetailedForecastApi) : RepoInterface  {
     ...
     override suspend fun getDailyForecasts(cityLatAndLong: List<Double>): Response<DaysForecasts> = api3.getDetailedForecasts(cityLatAndLong.get(0).toString(),cityLatAndLong.get(1).toString())
